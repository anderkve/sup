...
import os
import argparse
from sup import listmode, colorsmode, plrmode, plr1dmode, maxminmode, avgmode, histmode, postmode
...
modes:
  ...
  sup plr     plot the profile likelihood ratio across the (x,y) plane
...
examples:
  ...
  # sup post    plot the z posterior probability density
    ...
    parser_plrmode.add_argument("-f", "--filter", nargs="+", type=int, action="store", dest="filter_indices", default=None, help="indices of boolean datasets used for filtering", metavar="F_INDEX")
    ...
    parser_plrmode.add_argument("-ns", "--no-star", action="store_true", dest="no_star", default=False, help="switch off the star marker for the max likelihood point(s)")
    ...
    parser_maxmode.add_argument("-f", "--filter", nargs="+", type=int, action="store", dest="filter_indices", default=None, help="indices of boolean datasets used for filtering", metavar="F_INDEX")
    ...
    parser_maxmode.add_argument("-rc", "--reverse-colormap", action="store_true", dest="reverse_colormap", default=False, help="reverse colormap")
    ...
    parser_minmode.add_argument("-f", "--filter", nargs="+", type=int, action="store", dest="filter_indices", default=None, help="indices of boolean datasets used for filtering", metavar="F_INDEX")
    ...
    parser_minmode.add_argument("-rc", "--reverse-colormap", action="store_true", dest="reverse_colormap", default=False, help="reverse colormap")
    ...
    parser_avgmode.add_argument("-f", "--filter", nargs="+", type=int, action="store", dest="filter_indices", default=None, help="indices of boolean datasets used for filtering", metavar="F_INDEX")
    ...
    parser_avgmode.add_argument("-rc", "--reverse-colormap", action="store_true", dest="reverse_colormap", default=False, help="reverse colormap")
    ...
    parser_histmode.add_argument("-n", "--normalise", action="store_true", dest="normalise_histogram", default=False, help="normalise histogram to integrate to unity")
    ...
    parser_histmode.add_argument("-rc", "--reverse-colormap", action="store_true", dest="reverse_colormap", default=False, help="reverse colormap")
